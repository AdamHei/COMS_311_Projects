...
public class ShortestPathTests {
    ...
    public void SimplestTest() {
        ...
        List<IGraph.Edge<IWeight>> expected = new ArrayList<>();
...
//        List<Edge<IWeight>> expected= new ArrayList<>();
...
//        expected.add(g.getEdge("T","Z"));
        ...
        List<IGraph.Edge<IWeight>> actual = ShortestPath(g, "A", "Z");
        printLists(actual);
    ...
    private static double findPathSum(List<IGraph.Edge<IWeight>> list) {
        double sum = 0.0;
        for (IGraph.Edge<IWeight> edge : list) {
    ...
    private static void printLists(List<IGraph.Edge<IWeight>> list1) {
        double sum = 0;
        for (IGraph.Edge<IWeight> edge : list1) {
